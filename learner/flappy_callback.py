...
class FlappySession(Callback):
    ...
    def on_episode_end(self, episode, logs={}):
        ...
        ep_stats = 'Iter: {0} | Game: {1:<5}| Steps: {2:<6}| Rwd: {3:<13.5f}| Score: {4:<2}'.\
            format(
                logs['iteration'], 
                logs['episode'], 
                logs['steps'], 
        ...
        #logs.update({'steps' : self.log_steps})
        ...
        if logs['score'] >= logs['gif']:
            ...
            path = os.getcwd() + '\\learner\\logs\\gifs\\'
    ...
    def on_step_end(self, step, logs={}):
        ...
        self.frames.append(cv2.transpose(logs.pop('x')))        # save image of frame
